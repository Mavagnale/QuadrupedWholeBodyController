#include "ReferencePublisher.h"

void ReferencePublisher::run()
{
    // starts the planner loop thread
	boost::thread ctrl_loop_t ( &ReferencePublisher::plannerLoop, this);     
	ros::spin();	    
}
...
void ReferencePublisher::plannerLoop()
{
...
int main(int argc, char** argv) {
    ...
    ros::init(argc, argv, "ref_publisher");
    ros::NodeHandle nh;

    ReferencePublisher refpub;
